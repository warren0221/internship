...
<style>
	...
	input[type = "text"],[type = "password"],[name="company_id"]{
  border-color: #2ecc71;
  color:#000;
}	
...
<div class="container-fluid">
	...
	<form action="" id="manage-user">	
		...
		<div class="form-group">
			...
			<input type="text" name="username" id="username" class="form-control" value="<?php echo isset($meta['username']) ? $meta['username']: '' ?>" required  autocomplete="off" required >
		</div>
		<div class="form-group">
...
<script>
	...
	$('#manage-user').submit(function(e){
		...
		if(pass.length <=0){
			$('[name="password"]').addClass("border-danger")
			$('#msg').html('<div class="alert alert-danger">Please Enter your Password</i>')
			...
			$('#msg').html('<div class="alert alert-danger">Please Choose your Company</i>')
